...
// --- 設定項目 ---
const CSV_FILE_PATH = 'combined_df.csv';             // ★入力CSVファイルへのパス
const MODEL_SAVE_PATH = 'rf_alm_model.json';        // ★保存するモデルファイル名
const TARGET_COLUMN = 'ALM';                        // ★目的変数のカラム名
const START_FEATURE_COLUMN = 'Age';                 // ★説明変数の開始カラム名
const END_FEATURE_COLUMN = 'CRP';                   // ★説明変数の終了カラム名
